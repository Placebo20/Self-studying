...
ListWidget::ListWidget(QWidget *parent)
{
    ...
    clear = new QPushButton("Clear All/Remove All", this);
    ...
    connect(rename, &QPushButton::clicked, this, &ListWidget::removeItem);
    connect(rename, &QPushButton::clicked, this, &ListWidget::renameItem);
    connect(clear, &QPushButton::clicked, this, &ListWidget::clearItems);
